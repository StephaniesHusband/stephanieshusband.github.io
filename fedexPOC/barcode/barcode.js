var BarcodePOC = BarcodePOC || {
   init: function($livestream) {
      var me = this;

      /** @private */
      // Create the QuaggaJS config object for the live stream
      var __liveStreamConfig = {
         inputStream: {
            type: "LiveStream",
            constraints: {
               width: {min: 640},
      ...
      var __fileConfig = $.extend({}, __liveStreamConfig, {
         inputStream: {
            size: 800
         }
      });
      ...
      $("input:file", $livestream).on("change", function(e) {
         if (e.target.files && e.target.files.length) {
            Quagga.decodeSingle($.extend({}, __fileConfig, {
